...
export class BankConnectionError extends AppError {
  constructor(message: string, details?: any) {
    super(message, 502, 'BANK_CONNECTION_ERROR');
    this.name = 'BankConnectionError';
  }
}

export class BudgetAdjustmentError extends AppError {
  constructor(message: string) {
    super(message, 500, 'BUDGET_ADJUSTMENT_ERROR');
    this.name = 'BudgetAdjustmentError';
  }
}

export class VersionConflictError extends AppError {
  constructor(message: string = 'Version conflict detected') {
